 ...
 * full lightbox at that photo. Single-use (only project-detail-view.tsx
 * renders this), so its own aspect ratio/spacing can be tuned for that
 * page's editorial scale without any cross-page blast radius.
 */
